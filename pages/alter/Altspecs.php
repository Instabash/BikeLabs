	...
	<form action="../../includes/moddetailprocess.inc.php" method="post">
		<div class="container">
			<div>
				...
				if($_GET['pkg'] == "genpkg1")
				{?>
					<h3>You have selected Genuine Package 1</h3><br>
				...
				<?php }}
				elseif($_GET['pkg'] == "genpkg2")
				{?>
					<h3>You have Genuine selected package 2</h3><br>
				...
				<?php }}
				elseif($_GET['pkg'] == "altpkg1")
				{?>
					<h3>You have selected Alter package 1</h3><br>
					<h5>Please specify what modification you would like to implement from the package you have selected.</h5><br>
					<?php
					$pkg3 = array(
