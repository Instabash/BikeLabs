...
else
{
	...
	while($row3 = mysqli_fetch_assoc($result3)) 
	{
		...
		{
			$bike1Name = $row3['bike_brand'] . "" . $row3['bike_model'] . "" . $row3['bike_year'];
		}
		if ($row3['bike_id'] == $bike2) 
		{
			$bike2Name = $row3['bike_brand'] . "" . $row3['bike_model'] . "" . $row3['bike_year'];
		}
	}
}
?>
...
<section id="postad" class="section postadsection content">
	<div class="container">
				...
				else
				{
					...
					while($row2= mysqli_fetch_assoc($result2)) 
					{
						...
						if ($row2['bike_id'] == $bike1) 
						{
							?>
							<td style="width: 30%;">
								<img src="/BikeLabs/images/sparepartimg/<?php echo $row2['bike_image_name']; ?>"> 
								<p><?php echo $row1['bike_image_name']; ?></p>
							</td>
							<?php 
						}
						...
						{
							?>
							<td style="width: 30%;"><img src="/BikeLabs/images/sparepartimg/<?php echo $row2['bike_image_name']; ?>"></td>
							<?php 
						}
					}
				}
		...
		<table style="width:100%" border="0">
			...
			<tr>
				<th>Engine Type</th>
				<td><p><?php echo $bike1eng; ?></p></td>
				<td><p><?php echo $bike2eng; ?></p></td>
			</tr>
			<tr>
				<th>Bore & Stroke</th>
				<td><p><?php echo $bike1bore_str; ?></p></td>
				<td><p><?php echo $bike2bore_str; ?></p></td>
			</tr>
			<tr>
				<th>Transmission</th>
				<td><p><?php echo $bike1trans; ?></p></td>
				<td><p><?php echo $bike2trans; ?></p></td>
			</tr>
			<tr>
				<th>Starting</th>
				<td><p><?php echo $bike1starting; ?></p></td>
				<td><p><?php echo $bike2starting; ?></p></td>
			</tr>
			<tr>
				<th>Frame</th>
				<td><p><?php echo $bike1frame; ?></p></td>
				<td><p><?php echo $bike2frame; ?></p></td>
			</tr>
			<tr>
				<th>Dimension (Lxwxh)</th>
				<td><p><?php echo $bike1dimensions; ?></p></td>
				<td><p><?php echo $bike2dimensions; ?></p></td>
			</tr>
			<tr>
				<th>Petrol Capacity</th>
				<td><p><?php echo $bike1petrol_cap; ?></p></td>
				<td><p><?php echo $bike2petrol_cap; ?></p></td>
			</tr>
			<tr>
				<th>Tyre at Front</th>
				<td><p><?php echo $bike1f_tyre; ?></p></td>
				<td><p><?php echo $bike2f_tyre; ?></p></td>
			</tr>
			<tr>
				<th>Tyre at Back</th>
				<td><p><?php echo $bike1b_tyre; ?></p></td>
				<td><p><?php echo $bike2b_tyre; ?></p></td>
			</tr>
			<tr>
				<th>Dry Weight</th>
				<td><p><?php echo $bike1dry_weight; ?></p></td>
				<td><p><?php echo $bike2dry_weight; ?></p></td>
			</tr>
		</table>
	</div>
</section>
