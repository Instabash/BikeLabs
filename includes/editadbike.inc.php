...
if (isset($_POST['images'])) 
{
	...
	{
		$sql = "UPDATE post_ad SET ad_title=?, ad_price=?, ad_description=?, ad_condition=?, ad_user_hname=?, ad_user_pcode=?, ad_user_country=?, ad_user_phone=?, bike_make=?, bike_year=? WHERE ad_id = ?;";
		...
		{
			mysqli_stmt_bind_param($stmt, "sssssssssss", $Title, $Price, $Description, $Condition, $HomeName, $PostCode, $CountryReg, $Phone, $Make, $Year, $ad_id);
