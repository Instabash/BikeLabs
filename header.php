		    ...
		    <ul class="navbar-nav mr-auto">
		    	<h2 class="unselectable" style="color: #dc3545;padding-right: 30px;">BikeLabs</h2>
		      	...
		      	<li class="nav-item header-padding" style="color: #dc3545;">
			        <a class="nav-link" href="spparts.php">Purchase spare parts</a>
		      	</li>
		      	...
		      	<li class="nav-item dropdown header-padding" style="color: #dc3545;">
			        ...
			        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
			          <a class="dropdown-item" href="newbikes.php">New Bikes</a>
			          <a class="dropdown-item" href="usedbikes.php">Used Bikes</a>
			        </div>
		      	</li>
		      	<li class="nav-item header-padding" style="color: #dc3545;">
		        	<a class="nav-link" href="postad.php">Post An Advertisement</a>
      			</li>
